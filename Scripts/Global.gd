extends Node
@export var tarara_path : String = "res://Sonido/tarara.wav"
var dificultad = "normal"
var con_tiempo = true
var tiempo_inicial = 300
var con_aceleron = true
var con_guardianes = true
var pausa = false
var tarara : AudioStreamPlayer

func _ready():
	tarara = AudioStreamPlayer.new()
	tarara.stream = load(tarara_path)
	add_child(tarara)
...
func resetear_juego():
	...
	ControlJuego.llave_obtenida = false
