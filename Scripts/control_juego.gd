...
@export var sonido_muerte_path : String = "res://Sonido/sonido_muerte.wav"
...
var malo3 = null
var malo4 = null
var aceleron_recarga_display = false
...
var sonido_muerte : AudioStreamPlayer

func _ready():
    print("Tiempo inicial configurado: " + str(tiempo_restante))
    
    muroInvisibleSalida = find_muro_invisible_salida()
    sonido_muerte = AudioStreamPlayer.new()
    sonido_muerte.stream = load(sonido_muerte_path)
    add_child(sonido_muerte)
