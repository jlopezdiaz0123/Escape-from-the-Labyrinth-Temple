...
var boton_guardianes_on
var boton_guardianes_off
...
func _ready():
	...
	boton_guardianes_on = $BotonGuardianesON
	boton_guardianes_off = $BotonGuardianesOFF
...
func _on_boton_recarga_aceleron_on_pressed():
	print("Modo con recarga aceleron seleccionado")
	Global.con_aceleron = true
	actualizar_botones()

func _on_boton_recarga_aceleron_off_pressed():
	print("Modo sin recarga aceleron seleccionado")
	Global.con_aceleron = false
	actualizar_botones()

func _on_boton_guardianes_on_pressed():
	print("Modo con guardianes seleccionado")
	Global.con_guardianes = true
	actualizar_botones()

func _on_boton_guardianes_off_pressed():
	print("Modo sin guardianes seleccionado")
	Global.con_guardianes = false
	actualizar_botones()
...
func actualizar_botones():
	...
	boton_guardianes_on.modulate = Color(1, 1, 1)
	boton_guardianes_off.modulate = Color(1, 1, 1)
	...
	if Global.con_guardianes:
		boton_guardianes_on.modulate = Color(1, 1, 0)
	else:
		boton_guardianes_off.modulate = Color(1, 1, 0)
